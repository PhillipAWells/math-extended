...
describe('Vector Assertions', () => {
	...
	describe('AssertVectorNonZero', () => {
		...
		it('should throw on invalid input', () => {
			expect(() => AssertVectorNonZero(null as unknown as number[])).toThrow();
			expect(() => AssertVectorNonZero(undefined as unknown as number[])).toThrow();
			expect(() => AssertVectorNonZero('invalid' as unknown as number[])).toThrow();
		});
