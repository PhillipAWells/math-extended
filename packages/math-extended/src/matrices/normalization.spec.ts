...
describe('Matrix Normalizations', () => {
	describe('MatrixFrobeniusNorm', () => {
		...
		test('should throw error for invalid matrix', () => {
			expect(() => MatrixFrobeniusNorm('invalid' as unknown as number[][])).toThrow();
		});
	});
	...
	describe('MatrixSpectralNorm', () => {
		...
		test('should throw error for invalid matrix', () => {
			expect(() => MatrixSpectralNorm('invalid' as unknown as number[][])).toThrow();
		});
	});
	...
	describe('MatrixNuclearNorm', () => {
		...
		test('should throw error for invalid matrix', () => {
			expect(() => MatrixNuclearNorm('invalid' as unknown as number[][])).toThrow();
		});
	});
		...
		test('should throw error for invalid matrices across all norm functions', () => {
			...
			invalidInputs.forEach((input) => {
				normFunctions.forEach((func) => {
					expect(() => func(input as unknown as number[][])).toThrow();
				});
				expect(() => MatrixPNorm(input as unknown as number[][], 2)).toThrow();
			});
		});
	});
