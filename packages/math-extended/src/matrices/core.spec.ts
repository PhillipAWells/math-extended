...
describe('Matrices Core', () => {
	describe('MatrixCreate', () => {
		...
		test('should throw error for negative rows', () => {
			expect(() => MatrixCreate(-1 as number)).toThrow('Rows must be a non-negative integer');
		});
		...
		test('should throw error for non-integer rows', () => {
			expect(() => MatrixCreate(2.5 as number)).toThrow('Rows must be a non-negative integer');
		});
	...
	describe('MatrixSize', () => {
		...
		test('should throw error for invalid matrix', () => {
			expect(() => MatrixSize('invalid' as unknown as number[][])).toThrow();
		});
	});
	...
	describe('MatrixIsZero', () => {
		...
		test('should throw error for invalid matrix', () => {
			expect(() => MatrixIsZero('invalid' as unknown as number[][])).toThrow();
		});
	...
	describe('MatrixClone', () => {
		...
		test('should throw error for invalid matrix', () => {
			expect(() => MatrixClone('invalid' as unknown as number[][])).toThrow();
		});
	});
