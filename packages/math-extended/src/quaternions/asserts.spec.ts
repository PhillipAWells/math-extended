...
describe('Quaternions Assertions', () => {
	...
	describe('AssertNormalizedQuaternion', () => {
		...
		test('should validate quaternion first', () => {
			expect(() => AssertNormalizedQuaternion([1, 2, 3] as unknown as TQuaternion)).toThrow(QuaternionError);
			expect(() => AssertNormalizedQuaternion('invalid' as unknown as TQuaternion)).toThrow(QuaternionError);
		});
	});
	...
	describe('AssertQuaternions', () => {
		...
		test('should throw for non-arrays', () => {
			expect(() => AssertQuaternions(null as unknown as unknown[])).toThrow(QuaternionError);
			expect(() => AssertQuaternions(undefined as unknown as unknown[])).toThrow(QuaternionError);
			expect(() => AssertQuaternions(123 as unknown as unknown[])).toThrow(QuaternionError);
			expect(() => AssertQuaternions('string' as unknown as unknown[])).toThrow(QuaternionError);
			expect(() => AssertQuaternions({} as unknown as unknown[])).toThrow(QuaternionError);
		});
	...
	describe('ValidateNormalizedQuaternion', () => {
		...
		test('should return false for invalid quaternions', () => {
			expect(ValidateNormalizedQuaternion([1, 2, 3] as unknown as TQuaternion)).toBe(false);
			expect(ValidateNormalizedQuaternion('invalid' as unknown as TQuaternion)).toBe(false);
		});

		test('should not throw on invalid input', () => {
			expect(() => ValidateNormalizedQuaternion(null as unknown as TQuaternion)).not.toThrow();
			expect(() => ValidateNormalizedQuaternion('invalid' as unknown as TQuaternion)).not.toThrow();
		});
	});
	...
	describe('ValidateQuaternions', () => {
		...
		test('should return false for non-arrays', () => {
			expect(ValidateQuaternions(null as unknown as unknown[])).toBe(false);
			expect(ValidateQuaternions(undefined as unknown as unknown[])).toBe(false);
			expect(ValidateQuaternions('string' as unknown as unknown[])).toBe(false);
		});
		...
		test('should not throw on invalid input', () => {
			expect(() => ValidateQuaternions(null as unknown as unknown[])).not.toThrow();
			expect(() => ValidateQuaternions('invalid' as unknown as unknown[])).not.toThrow();
		});
	});
});
